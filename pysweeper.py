...
toolbarBG = UIElement(BORDER, BORDER, screen.width - (BORDER * 2), TOOLBARHEIGHT, screen, '', 1)
...
toolbarHelpBG = UIElement(BORDER, BORDER, screen.width - (BORDER * 2), TOOLBARHEIGHT, screen, '', 1)
...
toolbarGameOverBG = UIElement(BORDER, BORDER, screen.width - (BORDER * 2), TOOLBARHEIGHT, screen, '', 1)
...
uiElements = [toolbarBG, toolbarRowsText, toolbarColumnsText, toolbarMinesText]
